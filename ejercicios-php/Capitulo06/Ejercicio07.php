...
<?php 
  if (isset($_POST["background"])) {
    ...
    setcookie("background", $background, time() + 3*24*3600);
...
<html>
  <head>
      <meta charset="UTF-8">
      <title>Capítulo 6 - Ejercicio 7</title>
      <link type="text/css" rel="stylesheet" href="css/stylesheet.css">
      <link type="text/css" rel="stylesheet" href="css/font-awesome.css">
    </head>
  <body>
      <div id="cuerpo" style="background-color: <?=$background?>">
      <h1 id="cabecera">Escribe un programa que guarde en una cookie el color de fondo (propiedad background-color ) de
      una página. Esta página debe tener únicamente algo de texto y un formulario para cambiar el color.</h1>
        
        <form action="#" method="post">
          <input placeholder="Color" type="text" name ="background">
          <button type="submit" class="cesta fa  fa-share">Aplicar</button>
        </form>
        
        <p class="centrado">Lorem ipsum ad his scripta blandit partiendo, eum fastidii accumsan euripidis in, eum liber hendrerit an. Qui ut wisi vocibus suscipiantur, quo dicit ridens inciderint id. Quo mundi lobortis reformidans eu, legimus senserit definiebas an eos. Eu sit tincidunt incorrupte definitionem, vis mutat affert percipit cu, eirmod consectetuer signiferumque eu per. In usu latine equidem dolores. Quo no falli viris intellegam, ut fugit veritus placerat per.
