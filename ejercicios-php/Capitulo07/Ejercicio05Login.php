  ...
  <body>
    <div id="cuerpo">
        ...
        if (!$_SESSION['autenticado'])  {
          ?>
          <form action="Ejercicio05Login.php" method="post" class="panelLogin">
              <p class="panelLogin">Login</p>
            <fieldset>
                
              <form action="Ejercicio05Login.php" method="post" >
          ...
          if (isset($_POST['user'])) {
            ...
            if ($consulta->rowCount() > 0) {
              ...
              if (($_POST['user'] == $usuario) && ($_POST['pass'] == $password)) {       
                ...
                header("Refresh: 1; url=Ejercicio05.php"); // recarga la página
              ...
              header("Refresh: 0; url=Ejercicio05.php"); // recarga la página
        }
